...
export const ERROR_MESSAGES: Record<AppErrorCode, string> = {
  ...
  TITLE_EMPTY: 'Заголовок заметки не может быть пустым.',
  TITLE_TOO_LONG: 'Заголовок слишком длинный (максимум 100 символов).',
  CONTENT_TOO_LONG: 'Текст заметки превышает допустимый лимит символов.',
  INVALID_ID_FORMAT: 'Передан некорректный формат идентификатора.',
